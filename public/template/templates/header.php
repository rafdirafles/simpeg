...
<!-- Mirrored from keenthemes.com/metronic/preview/demo2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Sep 2019 06:17:11 GMT -->
...
<head>
        ...
        <link rel="shortcut icon" href="https://keenthemes.com/metronic/themes/metronic/theme/default/demo2/dist/../assets/media/logos/favicon.ico" />
    </head>
    <!-- end::Head -->
...
<div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
	<div class="kt-header__brand-logo">
		<a href="index.html">
			<img alt="Logo" Width="10%" src="../assets/media/logos/logoakpol.png" class="kt-header__brand-logo-default"/>
			<img alt="Logo" width="10%" src="../assets/media/logos/logoakpol.png" class="kt-header__brand-logo-sticky"/>
		</a>		
	</div> 
...
<!--end: Grid Nav -->            </form>
	...
	<div class="kt-header__topbar-item kt-header__topbar-item--langs">
		<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,10px">
			<span class="kt-header__topbar-icon">
				<img class="" src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo2/dist/../assets/media/flags/012-uk.svg" alt="" />
			</span>
		</div>
    ...
    <li class="kt-nav__item kt-nav__item--active">
        <a href="#" class="kt-nav__link">
            <span class="kt-nav__link-icon"><img src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo2/dist/../assets/media/flags/020-flag.svg" alt="" /></span>
            <span class="kt-nav__link-text">English</span>
        </a>
    </li>
    <li class="kt-nav__item">
        <a href="#" class="kt-nav__link">
            <span class="kt-nav__link-icon"><img src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo2/dist/../assets/media/flags/016-spain.svg" alt="" /></span>
            <span class="kt-nav__link-text">Spanish</span>
        </a>
    </li>
    <li class="kt-nav__item">
        <a href="#" class="kt-nav__link">
            <span class="kt-nav__link-icon"><img src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo2/dist/../assets/media/flags/017-germany.svg" alt="" /></span>
