...
<a href="#" class="kt-widget__data">{{auth::user()->no_tlp}}</a>
</div>
...
<div class="col-lg-9 col-xl-6">
    <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar">
        <div class="kt-avatar__holder" style="background-image: url(assets/media/users/100_1.html);"></div>
...
<div class="col-lg-9 col-xl-6">
    <input class="form-control" type="text" value="{{auth::user()->nama_pegawai}}">
</div>
</div>
