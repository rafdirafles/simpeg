    ...
    <form class="kt-form kt-form--label-right" action="{{route('master.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    <div class="col-lg-3">
                        <label>NIP / NRP</label>
                        <input type="text" name="nip_nrp" value="{{ old('nip_nrp') }}" class="form-control @error('nip_nrp') is-invalid @enderror" placeholder="Masukkan NIP/NRP">
                        @error('nip_nrp')
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" name="hobi" value="{{ old('hobi') }}" class="form-control @error('hobi') is-invalid @enderror" placeholder="Masukkan Nama Lengkap">
                        @error('hobi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="file"  name="foto" class="form-control @error('foto') is-invalid @enderror" value="{{ old('foto') }}" placeholder="Masukkan Email">
                            @error('foto')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
